...
<html lang="en" dir="ltr">
	...
	<body>
			...
			<div class="sidebar">
				<div class="sidebar-menu">
					...
					<li class="item" id="cursos">
						...
						<div class="sub-menu">
							<a href="./cursophp.php"><i class="fas fa-envelope"></i><span>Curso PHP</span></a>
        ...
        <div class="row">
            <div class="col" onclick="playVideo('https://www.youtube.com/embed/F7KzJ7e6EAc')">
                <div class="feature-img">
					<img src="media/pic1.png" alt="" width="100%">
					<img src="media/play.png" alt="" class="play-btn"
					onclick="playVideo('https://www.youtube.com/embed/F7KzJ7e6EAc')">
                </div>
            </div>
            <div class="col">
                <div class="small-img-row" onclick="playVideo('https://www.youtube.com/embed/Eup6utTPe2U')">
                    <div class="small-img">
						<img src="media/pic2.png" alt="">
						<img src="media/play.png" alt="" class="play-btn"
						onclick="playVideo('https://www.youtube.com/embed/Eup6utTPe2U')">
                    </div>
                    <p>
                        Como funciona o PHP?<br>
                    </p>
                </div>
                <div class="small-img-row" onclick="playVideo('https://www.youtube.com/embed/3ltZBbKACh4')">
                    <div class="small-img">
						<img src="media/pic3.png" alt="">
						<img src="media/play.png" alt="" class="play-btn"
						onclick="playVideo('https://www.youtube.com/embed/3ltZBbKACh4')">
                    </div>
                    <p>
                        Instalando o PHP<br>
                    </p>
                </div>
                <div class="small-img-row" onclick="playVideo('https://www.youtube.com/embed/DGZS9KrlrjI')">
                    <div class="small-img">
						<img src="media/pic4.png" alt="">
						<img src="media/play.png" alt="" class="play-btn"
						onclick="playVideo('https://www.youtube.com/embed/DGZS9KrlrjI')">
                    </div>
                    <p>
                        Variáveis no PHP<br>
                    </p>
