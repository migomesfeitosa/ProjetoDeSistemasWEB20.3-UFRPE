...
<html lang="en" dir="ltr">
	...
	<body>
        ...
        <div class="row">
            <div class="col" onclick="playVideo('https://www.youtube.com/embed/Ptbk2af68e8')">
                <div class="feature-img">
					<img src="media/pic1.png" alt="" width="100%">
					<img src="media/play.png" alt="" class="play-btn"
                         onclick="playVideo('https://www.youtube.com/embed/Ptbk2af68e8')">
                </div>
            </div>
            <div class="col">
                <div class="small-img-row" onclick="playVideo('https://www.youtube.com/embed/rUTKomc2gG8')">
                    <div class="small-img">
						<img src="media/pic2.png" alt="">
						<img src="media/play.png" alt="" class="play-btn"
                             onclick="playVideo('https://www.youtube.com/embed/rUTKomc2gG8')">
                    </div>
                    <p>
					JavaScript: como chegamos até aqui? - Curso JavaScript #02<br>
                    </p>
                </div>
                <div class="small-img-row" onclick="playVideo('https://www.youtube.com/embed/FdePtO5JSd0')">
                    <div class="small-img">
						<img src="media/pic3.png" alt="">
						<img src="media/play.png" alt="" class="play-btn"
                             onclick="playVideo('https://www.youtube.com/embed/FdePtO5JSd0')">
                    </div>
                    <p>
					Dando os primeiros passos - Curso JavaScript #03<br>
                    </p>
                </div>
                <div class="small-img-row" onclick="playVideo('https://www.youtube.com/embed/OmmJBfcMJA8')">
                    <div class="small-img">
						<img src="media/pic4.png" alt="">
						<img src="media/play.png" alt="" class="play-btn"
                             onclick="playVideo('https://www.youtube.com/embed/OmmJBfcMJA8')">
                    </div>
                    <p>
					Criando o seu primeiro script - Curso JavaScript #04<br>
                    </p>
                </div>
            </div>
        </div>
